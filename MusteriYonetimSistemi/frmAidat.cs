...
namespace MusteriYonetimSistemi
{
    public partial class frmAidat : Form
    {
        ...
        {
            var dates = kursOdemeler.genelKayitVeIslemlers.Select(x => x.odemeTarihi).ToList();
        ...
        private async void LoadData()
        {
            ...
            var aidat = kursOdemeler.finansalGelirlers
                .Where(x => x.gelirTarihi.Year == yil && x.gelirKalemi == "AİDAT")
        ...
        private void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewColumn column in dgvAidat.Columns)
                {
                    dt.Columns.Add(column.HeaderText);
                }

                foreach (DataGridViewRow row in dgvAidat.Rows)
                {
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    saveFileDialog.FileName = "Aidat.xlsx";
